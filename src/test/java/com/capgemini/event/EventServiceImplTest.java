...
// sampleEvent = new Event("Sample Event", "Event Description", LocalDate.now(),
// LocalTime.now(), "Event Location", 100, null, sampleOrganizer);
...
// Event eventToCreate = new Event("New Event", "New Desc",
// LocalDate.now().plusDays(5), LocalTime.now().plusHours(2), "New Location",
// 50, null, sampleOrganizer);
...
// @Test
// void getAllEvents() {
// List<Event> events = Arrays.asList(sampleEvent, new Event("Event 2", "Desc
// 2", LocalDate.now(), LocalTime.now(), "Loc 2", 20, null, sampleOrganizer));
...
// Event eventDetailsToUpdate = new Event("Updated Title", "Updated Desc",
// LocalDate.now().plusDays(1), LocalTime.now().plusHours(1), "New Location",
// 150, null, sampleOrganizer);

// Event existingEvent = new Event("Original Title", "Original Desc",
// LocalDate.now(), LocalTime.now(), "Original Location", 100, null,
// sampleOrganizer);
